...
class ActionTellClubInfo(Action):
    ...
    async def run(
        ...
        if not result_data.empty:
            msg = "Club Name : "+club_name+"\nTeacher in charge : "+str(result_data["Club_Lead"].iloc[0])+ "\nClub President : "+str(result_data["Club_President"].iloc[0])+ "\nClub President Contact details: "+str(result_data["Club_President_Contact"].iloc[0])+ "\nClub Vice President : "+str(result_data["Club_VP"].iloc[0])+ "\nClub Vice President Contact: "+str(result_data["Club_VP_Contact"].iloc[0])+ "\nGeneral Secretary : "+str(result_data["Club_Gen_Sec"].iloc[0])+ "\nGeneral Secretary Contact: "+str(result_data["Club_Gen_Sec_Contact"].iloc[0])+ "\nClub Treasurer : "+str(result_data["Club_Treasurer"].iloc[0])+ "\nTreasurer Contact : "+str(result_data["Club_Treasurer_Contact"].iloc[0])+"\nClub Description : "+str(result_data["Club_Description"].iloc[0])+"\nInstagram Handle : https://instagram.com/"+str(result_data["Insta_handle"].iloc[0])+ "\nClub Full Form: "+str(result_data["Full_Form"].iloc[0])
        else:
...
#         message_title = (
#             "Sorry, I'm not sure I've understood you correctly 🤔 Can you please rephrase?"
#         )
#         dispatcher.utter_message(text=message_title)
